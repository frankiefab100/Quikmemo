...
const Button = ({ variant = "primary", children, ...props }: ButtonProps) => {
  const baseStyles =
    "flex justify-center items-center text-center text-sm font-medium rounded-md focus:outline-none transition duration-100";

  const variants = {
    primary: "px-5 py-2.5 bg-blue-700 text-white hover:bg-blue-800",
    secondary: "px-4 py-1 bg-blue-600 text-white hover:bg-blue-700",
    outline:
